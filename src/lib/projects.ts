...
export const projects: Project[] = [
  ...
  },
  {
    ...
    heroImage: "/img/archive/spark-company-victory-wide.jpg",
    intro:
  ...
  },
  {
    slug: "naft-markazi",
    category: "perfume",
    title: "پروژه نفت مناطق مرکزی ایران",
    desc: "طراحی عطر سازمانی",
    client: "شرکت نفت مناطق مرکزی ایران",
    year: "۱۴۰۴",
    scope: ["مشاوره و نیازسنجی", "طراحی رایحه سازمانی", "تولید تیراژ سازمانی", "برگزاری نمایشگاه"],
    image: "/img/products/nira-versace-crystal-noir.jpg",
    intro:
      "طراحی و تولید عطر سازمانی برای شرکت نفت مناطق مرکزی ایران، همراه با برگزاری نمایشگاه عطر و ادکلن در محل سازمان برای معرفی محصولات به کارکنان.",
    sections: [
      {
        title: "نیازسنجی",
        body: "با توجه به گستردگی مخاطب سازمانی، چند رایحه در طیف‌های مختلف طراحی شد تا هر فرد بتواند نزدیک‌ترین گزینه به سلیقه‌ی خود را انتخاب کند.",
      },
      {
        title: "نمایشگاه",
        body: "غرفه‌ای در محل سازمان برپا شد تا کارکنان امکان تست رایحه‌ها و مشاوره‌ی حضوری با تیم نیرا را داشته باشند.",
      },
    ],
  },
  {
